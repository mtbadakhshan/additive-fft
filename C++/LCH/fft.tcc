...
namespace lch {
    ...
    // Templated radix-2^K LCH AFFT. K=1 uses the generalized radix-2 path;
    // K=2 is radix-4; K in {3, 4, 5} fuses 3, 4, 5 consecutive
                                             ...
                                             const size_t domain_dim, const size_t shift_dim)
    {
        ...
        inv_butterfly_radix2k<K, FieldT>(g, n, shift_dim, cantor_combinations);
        inv_basis_conversion(g, n);
        return g;
    }
                                               ...
                                               const size_t domain_dim, const size_t shift_dim)
    {
        ...
        inv_butterfly_parallel(g, n, shift_dim, cantor_combinations);
        inv_basis_conversion(g, n);
        return g;
    }
                                                       ...
                                                       const size_t domain_dim, const size_t shift_dim)
    {
        ...
        inv_butterfly_radix2k_parallel<K, FieldT>(g, n, shift_dim, cantor_combinations);
        inv_basis_conversion(g, n);
        return g;
    }
